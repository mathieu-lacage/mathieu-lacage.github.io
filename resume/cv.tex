...
\item Stay cool under pressure when everything is down
\end{itemize}
...
I wrote go code for our centralized micro-services and our distributed
storage software:
\begin{itemize}
\item Metric collection, analysis, monitoring, and alerting
        spanning centralized infrastructure and a p2p network
\item Debuging and fixing network and IO problems to scale the Hive p2p network
\item Building python-based developement, testing, and debugging tools
\item Planing and managing component-level testing strategies
\item Designing forward error correction policies around dynamic
