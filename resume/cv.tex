...
\begin{center}
I build Secure Backend Software and Infrastructure
\end{center}
...
Security
\begin{itemize}
\item Deployed an SSO for identification across
    all internal applications, including SSH.

\item HCVault to manage secrets, and, encryptions keys
\end{itemize}
...
As CTO, I focused on finding practical ways to
\begin{itemize}
\item Improve the confidentiality without impairing the availability of customer data via at-rest encryption, centralized access control
  and development tools.
\item Scale our code and infrastructure to 50\% YoY volume growth with 1000\% YoY peak volume growth.
\item Minimize the size and complexity of our codebase.
\end{itemize}

As co-founder, I invested my efforts in
\begin{itemize}
\item product design to ensure we build features that work in production
\item making sure we deliver high quality customer support
\item presales to design the right product for prospects
\end{itemize}
