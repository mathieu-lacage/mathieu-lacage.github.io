...
\item Infrastructure tools: MySQL, Ansible, uWSGI, Prometheus, Grafana, HCVault
\end{itemize}

Extensive practical and theoretical knowledge about
\begin{itemize}
\item Networking: from wifi MAC, to IP and TCP
...
Research domain-specific SLMs (Small Language Models) under 1B parameters
